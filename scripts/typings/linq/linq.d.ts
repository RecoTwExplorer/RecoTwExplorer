...
declare module linqjs {
    ...
    interface IEnumerable<T> {
        ...
        zip<TSecond, TResult>(second: IEnumerable<TSecond>, resultSelector: (first: T, second: TSecond, index: number) => TResult): IEnumerable<TResult>;
        zip<TSecond, TResult>(second: { length: number;[x: number]: T; }, resultSelector: (first: T, second: TSecond, index: number) => TResult): IEnumerable<TResult>;
        zip<TSecond, TResult>(second: TSecond[], resultSelector: (first: T, second: TSecond, index: number) => TResult): IEnumerable<TResult>;
        ...
        orderBy<TKey>(keySelector: (element: T) => TKey, compareSelector: (x: TKey, y: TKey) => number): IOrderedEnumerable<T>;
        orderByDescending<TKey>(keySelector: (element: T) => TKey): IOrderedEnumerable<T>;
        orderByDescending<TKey>(keySelector: (element: T) => TKey, compareSelector: (x: TKey, y: TKey) => number): IOrderedEnumerable<T>;
    ...
    interface IOrderedEnumerable<T> extends IEnumerable<T> {
        ...
        thenBy<TKey>(keySelector: (element: T) => TKey, compareSelector: (x: TKey, y: TKey) => number): IOrderedEnumerable<T>;
        thenByDescending<TKey>(keySelector: (element: T) => TKey): IOrderedEnumerable<T>;
        thenByDescending<TKey>(keySelector: (element: T) => TKey, compareSelector: (x: TKey, y: TKey) => number): IOrderedEnumerable<T>;
    }
